            ...
            <?php $payment_mode='phone';?>
                                ...
                                <div class="">
                                    ...
                                    <input
                                        ...
                                        name="cpm_custom"
                                        id="cpm_custom"
                                        value="{'payment_by':'<?php echo $payment_by; ?>','payment_to':'<?php echo $payment_to; ?>','payment_mode':'<?php echo $payment_mode; ?>','payment_for':'<?php echo $payment_for; ?>','reference_id':'<?php echo $reference_id; ?>','cpm_trans_id':'<?php echo $cpm_trans_id; ?>','Wallet':'0','commission':'0','orginal_amount':'0','fee':'0','margin':'0','market':'','operator':'','pos':'1'}"/>
...
function checkOperator(){
    ...
    // operator
        ...
        $("#payment_form").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: '<?= base_url("index.php/web/PosPayment/addPayment"); ?>',
                data: fd,
