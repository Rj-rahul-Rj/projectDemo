                        ...
                        <div id="form-1-div" class="card">
                            ...
                            <form id="payment_form" name="myForm" class="form-group" method="post">
                                ...
                                <div class="icon-container">
                                    <input type="radio" onclick="checkMode()" name="payemtMode" value="card"
                                    <?php echo ($payment_mode=='card'?' checked=checked':''); ?>>
                                    <i class="fab fa-cc-visa" style="color: navy;"></i>
                                    <i class="fab fa-cc-amex" style="color: blue;"></i>
                                    <i class="fab fa-cc-mastercard" style="color: red;"></i>
                                    <i class="fab fa-cc-paypal" style="color: ;"></i>
                                    <input type="radio" onclick="checkMode()" name="payemtMode" value="phone"<?php echo ($payment_mode=='phone'?' checked=checked':''); ?>
                                    class="ml-3">
         ...
         if($("input:radio[name='payemtMode']").val() =='card'){
            ...
            <?php $payment_mode='phone';?>
                                ...
                                <div class="">
                                    ...
                                    <input type="text" readonly=""id="cpm_currency" name="cpm_currency" class="form-select form-control" value="<?php echo $currencyCheck;?>">
                                    ...
                                    <select name="cpm_Market" class="form-select form-control phoneConfig" aria-label="Default select example" onchange="checkMarket()" >
                                        ...
                                        ?>
                                        <option value="<?php echo $value['market_name'];?>" <?php if($market==$value['market_name']) echo "selected";?>><?php echo $value['market_name']; ?></option>
                                    <?php } } else { ?>
                                    ...
                                    <input class="phoneConfig" type="text" name="cel_phone_num" value="<?php echo $phone; ?>"  />
                                    <span id="cel_phone_num_err" class="text-danger"></span>
                                    <label class="phoneConfig">phone_prefixe</label>
                                    <input class="phoneConfig" type="text" name="cpm_phone_prefixe"  value="<?php echo $country_code; ?>" />
                                    ...
                                    <input
                                        ...
                                        name="cpm_custom"
                                        id="cpm_custom"
                                        value="{'payment_by':'<?php echo $payment_by; ?>','payment_to':'<?php echo $payment_to; ?>','payment_mode':'<?php echo $payment_mode; ?>','payment_for':'<?php echo $payment_for; ?>','reference_id':'<?php echo $reference_id; ?>','cpm_trans_id':'<?php echo $cpm_trans_id; ?>','is_web':'<?php echo $is_web; ?>','Wallet':'0','commission':'0','orginal_amount':'0','fee':'0','margin':'0','market':'','operator':'','pos':'<?php echo $pos; ?>'}"/>
...
// show and set value for amount field if it is wallet topup request
  ...
  if(payment_for_wallet == 3 || payment_for_wallet == 8)
  {
